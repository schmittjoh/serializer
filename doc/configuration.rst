...
metadata in XML, or YML files.
For the former, `annotation classes need to be loaded with a silent autoloader <http://docs.doctrine-project.org/projects/doctrine-common/en/latest/reference/annotations.html#registering-annotations>`_.
If you installed the library with Composer, you can register the autoloader
generated by Composer, as it complies with the silence requirement::
...
For the latter, it is necessary to configure a metadata directory where those files
are located::
