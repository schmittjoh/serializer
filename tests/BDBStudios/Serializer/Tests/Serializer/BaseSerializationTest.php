...
use BDBStudios\Serializer\Handler\PhpCollectionHandler;
use BDBStudios\Serializer\SerializationContext;
use BDBStudios\Serializer\Tests\Fixtures\DateTimeArraysObject;
use BDBStudios\Serializer\Tests\Fixtures\Discriminator\Car;
use BDBStudios\Serializer\Tests\Fixtures\InlineChildEmpty;
use BDBStudios\Serializer\Tests\Fixtures\NamedDateTimeArraysObject;
use BDBStudios\Serializer\Tests\Fixtures\Tree;
use PhpCollection\Sequence;
use Symfony\Component\Form\FormFactoryBuilder;
use Symfony\Component\Translation\MessageSelector;
use Symfony\Component\Translation\IdentityTranslator;
use BDBStudios\Serializer\EventDispatcher\Subscriber\DoctrineProxySubscriber;
use BDBStudios\Serializer\Handler\HandlerRegistry;
...
use BDBStudios\Serializer\Construction\UnserializeObjectConstructor;
use BDBStudios\Serializer\Handler\ArrayCollectionHandler;
use BDBStudios\Serializer\Handler\ConstraintViolationHandler;
use BDBStudios\Serializer\Handler\DateHandler;
use BDBStudios\Serializer\Handler\FormErrorHandler;
use BDBStudios\Serializer\JsonDeserializationVisitor;
...
use BDBStudios\Serializer\XmlDeserializationVisitor;
use BDBStudios\Serializer\XmlSerializationVisitor;
use BDBStudios\Serializer\YamlSerializationVisitor;
use BDBStudios\Serializer\Tests\Fixtures\AccessorOrderChild;
use BDBStudios\Serializer\Tests\Fixtures\AccessorOrderParent;
use BDBStudios\Serializer\Tests\Fixtures\AccessorOrderMethod;
use BDBStudios\Serializer\Tests\Fixtures\Author;
use BDBStudios\Serializer\Tests\Fixtures\Publisher;
use BDBStudios\Serializer\Tests\Fixtures\AuthorList;
use BDBStudios\Serializer\Tests\Fixtures\AuthorReadOnly;
use BDBStudios\Serializer\Tests\Fixtures\BlogPost;
use BDBStudios\Serializer\Tests\Fixtures\CircularReferenceParent;
use BDBStudios\Serializer\Tests\Fixtures\Comment;
use BDBStudios\Serializer\Tests\Fixtures\CurrencyAwareOrder;
use BDBStudios\Serializer\Tests\Fixtures\CurrencyAwarePrice;
use BDBStudios\Serializer\Tests\Fixtures\CustomDeserializationObject;
use BDBStudios\Serializer\Tests\Fixtures\GetSetObject;
use BDBStudios\Serializer\Tests\Fixtures\GroupsObject;
use BDBStudios\Serializer\Tests\Fixtures\InvalidGroupsObject;
use BDBStudios\Serializer\Tests\Fixtures\IndexedCommentsBlogPost;
use BDBStudios\Serializer\Tests\Fixtures\InlineParent;
use BDBStudios\Serializer\Tests\Fixtures\InitializedObjectConstructor;
use BDBStudios\Serializer\Tests\Fixtures\InitializedBlogPostConstructor;
use BDBStudios\Serializer\Tests\Fixtures\Log;
use BDBStudios\Serializer\Tests\Fixtures\ObjectWithLifecycleCallbacks;
use BDBStudios\Serializer\Tests\Fixtures\ObjectWithVersionedVirtualProperties;
use BDBStudios\Serializer\Tests\Fixtures\ObjectWithVirtualProperties;
use BDBStudios\Serializer\Tests\Fixtures\Order;
use BDBStudios\Serializer\Tests\Fixtures\Price;
use BDBStudios\Serializer\Tests\Fixtures\SimpleObject;
use BDBStudios\Serializer\Tests\Fixtures\ObjectWithNullProperty;
use BDBStudios\Serializer\Tests\Fixtures\SimpleObjectProxy;
use BDBStudios\Serializer\Tests\Fixtures\Article;
use BDBStudios\Serializer\Tests\Fixtures\Input;
use BDBStudios\Serializer\Tests\Fixtures\ObjectWithEmptyHash;
...
use BDBStudios\Serializer\Exclusion\DepthExclusionStrategy;
use BDBStudios\Serializer\Tests\Fixtures\Node;
use BDBStudios\Serializer\Tests\Fixtures\AuthorReadOnlyPerClass;
...
abstract class BaseSerializationTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testArrayObjects()
    {
        ...
        if ($this->hasDeserializer()) {
            $this->assertEquals($data, $this->deserialize($this->getContent('array_objects'), 'array<BDBStudios\Serializer\Tests\Fixtures\SimpleObject>'));
        }
    }
    ...
    public function testDateTimeArrays()
    {
        ...
        if ($this->hasDeserializer()) {
            ...
            $deserializedObject = $this->deserialize($this->getContent('array_datetimes_object'), 'BDBStudios\Serializer\Tests\Fixtures\DateTimeArraysObject');
    ...
    public function testNamedDateTimeArrays()
    {
        ...
        if ($this->hasDeserializer()) {
            ...
            $deserializedObject = $this->deserialize($this->getContent('array_named_datetimes_object'), 'BDBStudios\Serializer\Tests\Fixtures\NamedDateTimeArraysObject');
    ...
    public function testArticle()
    {
        ...
        if ($this->hasDeserializer()) {
            $this->assertEquals($article, $this->deserialize($result, 'BDBStudios\Serializer\Tests\Fixtures\Article'));
        }
    }
    ...
    public function testMixedAccessTypes()
    {
        ...
        if ($this->hasDeserializer()) {
            $object = $this->deserialize($this->getContent('mixed_access_types'), 'BDBStudios\Serializer\Tests\Fixtures\GetSetObject');
    ...
    /**
     * @expectedException BDBStudios\Serializer\Exception\InvalidArgumentException
     * @expectedExceptionMessage Invalid group name "foo, bar" on "BDBStudios\Serializer\Tests\Fixtures\InvalidGroupsObject->foo", did you mean to create multiple groups?
     */
    ...
    public function testPolymorphicObjects()
    {
        ...
        if ($this->hasDeserializer()) {
            $this->assertEquals(
                ...
                $this->deserialize(
                    $this->getContent('car'),
                    'BDBStudios\Serializer\Tests\Fixtures\Discriminator\Car'
                ),
            ...
            $this->assertEquals(
                ...
                $this->deserialize(
                    $this->getContent('car'),
                    'BDBStudios\Serializer\Tests\Fixtures\Discriminator\Vehicle'
                ),
    ...
    public function testDeserializingIntoExistingObject()
    {
        ...
        $this->assertAttributeInstanceOf('BDBStudios\Serializer\Tests\Fixtures\Price', 'cost', $deseralizedOrder);
    }
            ...
            function(VisitorInterface $visitor, $data, $type, Context $context) {
                $type = array(
                    ...
                    'params' => array(
                        ...
                        array('name' => 'BDBStudios\Serializer\Tests\Fixtures\Author', 'params' => array()),
                    ),
                );
