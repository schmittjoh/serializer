...
use BDBStudios\Serializer\Tests\Fixtures\InvalidUsageOfXmlValue;
use BDBStudios\Serializer\Exception\InvalidArgumentException;
use BDBStudios\Serializer\Tests\Fixtures\PersonCollection;
use BDBStudios\Serializer\Tests\Fixtures\PersonLocation;
use BDBStudios\Serializer\Tests\Fixtures\Person;
use BDBStudios\Serializer\Tests\Fixtures\ObjectWithVirtualXmlProperties;
use BDBStudios\Serializer\Tests\Fixtures\ObjectWithXmlKeyValuePairs;
use BDBStudios\Serializer\Tests\Fixtures\ObjectWithXmlNamespaces;
use BDBStudios\Serializer\Tests\Fixtures\ObjectWithXmlRootNamespace;
use BDBStudios\Serializer\Tests\Fixtures\Input;
use BDBStudios\Serializer\Tests\Fixtures\SimpleClassObject;
use BDBStudios\Serializer\Tests\Fixtures\SimpleSubClassObject;

class XmlSerializationTest extends BaseSerializationTest
{
    /**
     * @expectedException BDBStudios\Serializer\Exception\RuntimeException
     */
    ...
    {
        $this->markTestSkipped('Failing for now on travis');
