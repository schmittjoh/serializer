...
namespace BDBStudios\Serializer\Tests\Serializer\Doctrine;
...
use BDBStudios\Serializer\Builder\CallbackDriverFactory;
use BDBStudios\Serializer\Builder\DefaultDriverFactory;
use BDBStudios\Serializer\Metadata\Driver\DoctrineTypeDriver;
use BDBStudios\Serializer\Serializer;
use BDBStudios\Serializer\SerializerBuilder;
use Doctrine\ORM\EntityManager;
use Doctrine\ORM\ORMException;
use BDBStudios\Serializer\Tests\Fixture\Doctrine\SingleTableInheritance\Clazz;
use BDBStudios\Serializer\Tests\Fixtures\Doctrine\SingleTableInheritance\Excursion;
use BDBStudios\Serializer\Tests\Fixtures\Doctrine\SingleTableInheritance\Person;
use BDBStudios\Serializer\Tests\Fixtures\Doctrine\SingleTableInheritance\Student;
...
class IntegrationTest extends \PHPUnit_Framework_TestCase
{
    ...
    private function createEntityManager(Connection $con)
    {
        ...
        $cfg->setProxyNamespace('BDBStudios\Serializer\DoctrineProxy');
