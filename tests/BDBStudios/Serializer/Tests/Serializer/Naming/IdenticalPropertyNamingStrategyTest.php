...
namespace BDBStudios\Serializer\Tests\Serializer\Naming;

use BDBStudios\Serializer\Naming\IdenticalPropertyNamingStrategy;
...
class IdenticalPropertyNamingStrategyTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $mockProperty = $this->getMockBuilder('BDBStudios\Serializer\Metadata\PropertyMetadata')->disableOriginalConstructor()->getMock();
