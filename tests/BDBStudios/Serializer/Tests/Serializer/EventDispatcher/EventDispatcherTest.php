...
namespace BDBStudios\Serializer\Tests\Serializer\EventDispatcher;
...
class EventDispatcherTest extends \PHPUnit_Framework_TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->event = new ObjectEvent($this->getMock('BDBStudios\Serializer\Context'), new \stdClass(), array('name' => 'foo', 'params' => array()));
    }
