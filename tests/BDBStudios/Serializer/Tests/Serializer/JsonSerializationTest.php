...
use BDBStudios\Serializer\EventDispatcher\Event;
use BDBStudios\Serializer\EventDispatcher\EventSubscriberInterface;
...
class JsonSerializationTest extends BaseSerializationTest
{
    ...
    public function testAddLinksToOutput()
    {
        ...
        $this->handlerRegistry->registerHandler(GraphNavigator::DIRECTION_SERIALIZATION, 'BDBStudios\Serializer\Tests\Fixtures\AuthorList', 'json',
    ...
    public function testPrimitiveTypes($primitiveType, $data)
    {
        ...
        $result = $visitor->$functionToCall($data, array(), $this->getMock('BDBStudios\Serializer\Context'));
...
class LinkAddingSubscriber implements EventSubscriberInterface
{
    ...
    {
        return array(
            array('event' => 'serializer.post_serialize', 'method' => 'onPostSerialize', 'format' => 'json', 'class' => 'BDBStudios\Serializer\Tests\Fixtures\Author'),
        );
    }
}
