...
{
    /** @Type("array<BDBStudios\Serializer\Tests\Fixtures\CircularReferenceChild>") */
    protected $collection = array();

    /** @Type("ArrayCollection<BDBStudios\Serializer\Tests\Fixtures\CircularReferenceChild>") */
