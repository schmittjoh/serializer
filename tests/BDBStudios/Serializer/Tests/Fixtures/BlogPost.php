...
class BlogPost
{
    ...
    /**
     * @Type("ArrayCollection<BDBStudios\Serializer\Tests\Fixtures\Comment>")
    ...
    /**
     * @Type("PhpCollection\Sequence<BDBStudios\Serializer\Tests\Fixtures\Comment>")
    ...
    /**
     * @Type("BDBStudios\Serializer\Tests\Fixtures\Publisher")
     */
    private $publisher;
