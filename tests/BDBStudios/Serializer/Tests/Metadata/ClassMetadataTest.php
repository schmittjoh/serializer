...
namespace BDBStudios\Serializer\Tests\Metadata;
...
class ClassMetadataTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $metadata = new ClassMetadata('BDBStudios\Serializer\Tests\Metadata\PropertyMetadataOrder');
        $metadata->addPropertyMetadata(new PropertyMetadata('BDBStudios\Serializer\Tests\Metadata\PropertyMetadataOrder', 'b'));
        $metadata->addPropertyMetadata(new PropertyMetadata('BDBStudios\Serializer\Tests\Metadata\PropertyMetadataOrder', 'a'));
    ...
    {
        $this->setExpectedException('\BDBStudios\Serializer\Exception\RuntimeException', $message);
