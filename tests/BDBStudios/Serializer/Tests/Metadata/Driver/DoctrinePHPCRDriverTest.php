...
use BDBStudios\Serializer\Metadata\Driver\DoctrinePHPCRTypeDriver;
...
class DoctrinePHPCRDriverTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $refClass = new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\DoctrinePHPCR\BlogPost');
    ...
    public function testSingleValuedAssociationIsProperlyHinted()
    {
        $metadata = $this->getMetadata();
        $this->assertEquals(
            array('name'=> 'BDBStudios\Serializer\Tests\Fixtures\DoctrinePHPCR\Author', 'params' => array()),
    ...
    public function testMultiValuedAssociationIsProperlyHinted()
    {
        ...
        $this->assertEquals(
            array('name'=> 'ArrayCollection', 'params' => array(
                array('name' => 'BDBStudios\Serializer\Tests\Fixtures\DoctrinePHPCR\Comment', 'params' => array()))
            ),
    ...
    public function testNonDoctrineDocumentClassIsNotModified()
    {
        ...
        $refClass = new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\BlogPost');
