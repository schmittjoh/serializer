...
class DoctrineDriverTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $refClass = new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\Doctrine\BlogPost');
    ...
    public function testSingleValuedAssociationIsProperlyHinted()
    {
        $metadata = $this->getMetadata();
        $this->assertEquals(
            array('name'=> 'BDBStudios\Serializer\Tests\Fixtures\Doctrine\Author', 'params' => array()),
    ...
    public function testMultiValuedAssociationIsProperlyHinted()
    {
        ...
        $this->assertEquals(
            array('name'=> 'ArrayCollection', 'params' => array(
                array('name' => 'BDBStudios\Serializer\Tests\Fixtures\Doctrine\Comment', 'params' => array()))
            ),
