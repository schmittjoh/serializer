...
$metadata = new ClassMetadata('BDBStudios\Serializer\Tests\Fixtures\BlogPost');
...
$pMetadata = new PropertyMetadata('BDBStudios\Serializer\Tests\Fixtures\BlogPost', 'id');
$pMetadata->setType('string');
$pMetadata->groups = array('comments','post');
$pMetadata->xmlElementCData = false;
$metadata->addPropertyMetadata($pMetadata);

$pMetadata = new PropertyMetadata('BDBStudios\Serializer\Tests\Fixtures\BlogPost', 'title');
$pMetadata->setType('string');
$pMetadata->groups = array('comments','post');
$pMetadata->xmlNamespace = "http://purl.org/dc/elements/1.1/";
$metadata->addPropertyMetadata($pMetadata);

$pMetadata = new PropertyMetadata('BDBStudios\Serializer\Tests\Fixtures\BlogPost', 'createdAt');
$pMetadata->setType('DateTime');
$pMetadata->xmlAttribute = true;
$metadata->addPropertyMetadata($pMetadata);

$pMetadata = new PropertyMetadata('BDBStudios\Serializer\Tests\Fixtures\BlogPost', 'published');
...
$pMetadata = new PropertyMetadata('BDBStudios\Serializer\Tests\Fixtures\BlogPost', 'etag');
$pMetadata->setType('string');
$pMetadata->groups = array('post');
$pMetadata->xmlAttribute = true;
...
$pMetadata = new PropertyMetadata('BDBStudios\Serializer\Tests\Fixtures\BlogPost', 'comments');
$pMetadata->setType('ArrayCollection<BDBStudios\Serializer\Tests\Fixtures\Comment>');
...
$pMetadata = new PropertyMetadata('BDBStudios\Serializer\Tests\Fixtures\BlogPost', 'author');
$pMetadata->setType('BDBStudios\Serializer\Tests\Fixtures\Author');
$pMetadata->groups = array('post');
