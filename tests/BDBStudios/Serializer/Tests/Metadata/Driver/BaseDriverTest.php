...
namespace BDBStudios\Serializer\Tests\Metadata\Driver;
...
abstract class BaseDriverTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\BlogPost'));
        ...
        $p->type = array('name' => 'ArrayCollection', 'params' => array(array('name' => 'BDBStudios\Serializer\Tests\Fixtures\Comment', 'params' => array())));
        ...
        $p->type = array('name' => 'BDBStudios\Serializer\Tests\Fixtures\Author', 'params' => array());
        $p->groups = array("post");
        $p->xmlNamespace = 'http://www.w3.org/2005/Atom';
        $this->assertEquals($p, $m->propertyMetadata['author']);

        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\Price'));
        $this->assertNotNull($m);
    ...
    {
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\ObjectWithVirtualProperties'));
    ...
    {
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\ObjectWithXmlKeyValuePairs'));
    ...
    {
        $a = new \BDBStudios\Serializer\Tests\Fixtures\ObjectWithVirtualPropertiesAndExcludeAll();
    ...
    {
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\AuthorReadOnly'));
    ...
    {
        /** @var $m ClassMetadata */
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\Discriminator\Vehicle'));
    ...
    {
        /** @var $m ClassMetadata */
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\Discriminator\Car'));
    ...
    {
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\ObjectWithXmlNamespaces'));
        $this->assertNotNull($m);
    ...
    {
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\Node'));
    ...
    {
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\Person'));
    ...
    {
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\SimpleClassObject'));
        $this->assertNotNull($m);
        $this->assertCount(3, $m->xmlNamespaces);
        ...
        $subm = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\SimpleSubClassObject'));
        ...
        $p->xmlNamespace = "http://old.foo.example.org";
        $p->xmlAttribute = true;
        $p->class = 'BDBStudios\Serializer\Tests\Fixtures\SimpleClassObject';
        $this->assertEquals($p, $m->propertyMetadata['foo']);
