...
{
    /**
     * @expectedException BDBStudios\Serializer\Exception\XmlErrorException
    ...
    {
        $m = $this->getDriver('exclude_all')->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\BlogPost'));
    ...
    {
        $m = $this->getDriver('exclude_none')->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\BlogPost'));
    ...
    {
        $m = $this->getDriver('case')->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\BlogPost'));
    ...
    {
        $m = $this->getDriver()->loadMetadataForClass(new \ReflectionClass('BDBStudios\Serializer\Tests\Fixtures\GetSetObject'));
    ...
    protected function getDriver()
    {
        ...
        return new XmlDriver(new FileLocator(array(
            'BDBStudios\Serializer\Tests\Fixtures' => __DIR__.'/xml'.$append,
        )));
    }
}
