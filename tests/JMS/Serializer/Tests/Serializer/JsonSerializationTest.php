...
class JsonSerializationTest extends BaseSerializationTest
{
    protected function getContent($key)
    {
        ...
        if (!$outputs) {
            ...
            $outputs['virtual_properties'] = '{"real_field":"real field value","virtual_field":"virtual field value","renamed_virtual_field":"renamed field value","typed_virtual_field":1}';
